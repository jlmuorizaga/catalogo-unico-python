...
crear_tabla_sql = '''
CREATE TABLE IF NOT EXISTS public.mgee_p
(
    ...
    CONSTRAINT mgee_p_pkey PRIMARY KEY (cvegeo)
)
'''
...
if respuesta.status_code == 200:
    ...
    for registro in datos['datos']:
        ...
        insertar_sql = '''
        INSERT INTO public.mgee_p(cvegeo, cve_ent, nomgeo, nom_abrev, pob_total, pob_femenina, pob_masculina, total_viviendas_habitadas)
